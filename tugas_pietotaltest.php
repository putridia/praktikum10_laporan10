...
while($row = mysqli_fetch_array($kasus)){
	...
	$query = mysqli_query($koneksi,"SELECT sum(totaltest) AS jumlah FROM tb_covid19 WHERE totaltest='".$row['totaltest']."'");
...
<body>
    <center><h2>LAPORAN GRAFIK PIE TOTAL TEST COVID-19</h2></center>
    <br>
