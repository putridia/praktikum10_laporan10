...
while($row = mysqli_fetch_array($kasus)){
	...
	$query = mysqli_query($koneksi,"SELECT sum(activecases) AS jumlah FROM tb_covid19 WHERE activecases='".$row['activecases']."'");
...
<body>
    <center><h2>LAPORAN GRAFIK PIE ACTIVE CASES COVID-19</h2></center>
    <br>
