...
while($row = mysqli_fetch_array($kasus)){
	...
	$query = mysqli_query($koneksi,"SELECT sum(totalrecover) AS jumlah FROM tb_covid19 WHERE totalrecover='".$row['totalrecover']."'");
...
<body>
    <center><h2>LAPORAN GRAFIK PIE TOTAL RECOVERED COVID-19</h2></center>
    <br>
