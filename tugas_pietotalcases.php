...
while($row = mysqli_fetch_array($kasus)){
	...
	$query = mysqli_query($koneksi,"SELECT sum(totalcases) AS jumlah FROM tb_covid19 WHERE totalcases='".$row['totalcases']."'");
...
<body>
    <center><h2>LAPORAN GRAFIK PIE TOTAL CASES COVID-19</h2></center>
    <br>
